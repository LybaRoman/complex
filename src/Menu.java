import banking.Bank;
import commands.BankCommands.BankChangeDepCom;
import commands.BankCommands.BankCreateDepCom;
import commands.BankCommands.BankDeleteDepCom;
import commands.BankCommands.BankShowDepsCom;
import commands.Command;
import commands.ExitCommand;
import commands.HelpCommand;
import commands.UserCommands.*;
import userclass.User;
import utils.CrashReportSender;
...
public class Menu {
    ...
    public static void initUser(User user) {
        ...
        if (JsonWorker.getJsonStringF().isEmpty()) {
            ...
            System.out.println("Critical error occupied.");
            System.exit(1);
        }
        ...
        switch (input) {
            ...
            case "Y":
                ...
                do {
                    ...
                    if (user.getUserID() == 0) {
                        ...
                        Log.logger.warning("Incorrect data. Check your password or login");
                    }
            ...
            case "N":
                ...
                String login = MyScanner.inp();
                String password = MyScanner.inp();
                user.register(fname, lname, login, password);
                Log.logger.info("End of registration");
                break;
            default:
                Log.logger.warning("Wrong input");
